...
'sdfopen http://' base '/gfs_0p25_1hr/gfs' date '/gfs_0p25_1hr_' hour 'z'
if ( rc ); return; endif
...
'define precip= sum(const(acpcpsfc,0,-u),t=' valid - 23 ',t=' valid + 1 ',2)'
...
'set gxout contour'
'set cthick 6'
'set clevs 992 994 996 998 1000 1002 1004 1006 1008 1010 1012'
'd ave(prmslmsl,t=' offs - 5 ',t=' offs + 1 ')/100'
