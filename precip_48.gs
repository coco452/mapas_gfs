...
ofs= (valid-48) / 3
'define pp= sum(const(acpcpsfc,0,-u),t=' ofs - 5 ',t=' ofs + 1 ',2)'
'define total = precip-pp'
...
'set string 1 bc 6'
'set strsiz .15 .18'
'draw string 5.5 8.2 GFS ' year '-' mon '-' day ' ' hour 'Z, PRECIPITACION DIARIA, Valid +' valid 'h'
